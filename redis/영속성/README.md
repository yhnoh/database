...
> [Redisgate > Params RDB](https://redisgate.kr/redis/configuration/param_save.php) <br/>
> [Redisgate > Params AOF](https://redisgate.kr/redis/configuration/param_appendonly.php) <br/>
